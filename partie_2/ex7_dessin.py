...
"Programme qui affiche un dessin comportant un arbre, un vélo et des nuages en utilisant"
"des hexagones et des triangles avec le module Turtle"
...
# Paramètres:
#  - coordonnées (tuple de deux integer)
#  - longeur de la ligne (integer),
#  - couleur (string (nom anglais) ou notation RGB)
#  - angle d'orientation du triangle (défaut: 0°)
...
def __main__(): #Définition de la fonction principale
    #Initialisation
    ...
    hideturtle() #On masque la tortue à la fin du dessin
...
__main__() #Execution du programme principal
